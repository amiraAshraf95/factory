...
public function Type($WorkerType,$table)
	...
	public function sig($table_name,$Email,$Password)
    {
		...
		public function update($table,$ID,$FirstName,$LastName,$Mobile,$Age,$WorkHours,$Address)
	    {
	    $Email=$_COOKIE["Email"];
		$string = "UPDATE ".$table." SET ID='$ID', FirstName ='$FirstName',LastName='$LastName',Mobile='$Mobile',Age='$Age',WorkHours='$WorkHours',Address='$Address' 
		WHERE Email='$Email' ";
