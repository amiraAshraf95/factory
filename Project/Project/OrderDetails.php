...
if(isset($_POST['submit']))
{
	...
	$dataa->orderdetails($tableName,$_POST['productID'],$_POST['Unit'],$_POST['quantity'],$_POST['orderID']);
...
$dataa->OrderTable($tableNamee,'ID','ClientID','Price','DeliverDate','PaymentMethodID');

$tableNameee='product';

$dataa->ProductTable($tableNameee,'ID','TypeName','TypeSize');
?>
<!DOCTYPE html>
<html>
    <head>
